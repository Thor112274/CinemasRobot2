...
GRP_LNK = environ.get('GRP_LNK', 'https://t.me/Ak_Entertinments')
CHNL_LNK = environ.get('CHNL_LNK', 'https://t.me/CultCinemas')
...
URL = "https://cultcinemasrobot2-4094332ace3c.herokuapp.com/".format(FQDN) if ON_HEROKU or NO_PORT else \
    "https://cultcinemasrobot2-4094332ace3c.herokuapp.com/".format(FQDN, PORT)
...
if HAS_SSL:
    URL = "https://cultcinemasrobot2-4094332ace3c.herokuapp.com/".format(FQDN)
else:
    URL = "https://cultcinemasrobot2-4094332ace3c.herokuapp.com/".format(FQDN)
